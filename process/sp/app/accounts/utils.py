...
def get_jwk():
    jwks_url = os.getenv('IDP_JWKS_URL') #"http://identityprovider:8001/auth/.well-known/jwks.json" #"http://host.docker.internal:8001" + "/auth/.well-known/jwks.json"# TODO fix this hack, see views.p
