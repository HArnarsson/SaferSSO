...
class OIDCTokenView(APIView):
    ...
    def post(self, request):
        ...
        token_url = "http://host.docker.internal:8001" + "/auth/token/"  # os.getenv('IDP_TOKEN_URL')#this is a bit of a hack TODO: fix docker compose and add networks to get around this (and then we can customize urls)
